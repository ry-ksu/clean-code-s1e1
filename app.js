...
var incompleteTaskHolder=document.querySelector(".incoplite-tasks");//ul of #incompleteTasks
...
var createNewTaskElement=function(taskString){
    ...
    editInput.className="input input_text list__text";
    editInput.type="text";
    

    editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
    editButton.className="button list__edit";

    deleteButton.className="button list__delete";
